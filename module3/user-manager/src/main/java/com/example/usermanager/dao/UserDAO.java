...
public class UserDAO {
    ...
    private static final String SELECT_ALL_USERS_ASC = "select * from users order by name";
    private static final String DELETE_USERS_SQL = "delete from users where id = ?;";
    private static final String UPDATE_USERS_SQL = "update users set name = ?,email= ?, country =? where id = ?;";
    public static final String SEARCH_USER_COUNTRY_SQL = "select * from users where country = ?";
    ...
    public List<User> search(String countryUser) {
        List<User> users = new ArrayList<>();
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SEARCH_USER_COUNTRY_SQL);) {
            System.out.println(preparedStatement);
    ...
    public boolean updateUserSQL(User user) throws SQLException {
        boolean rowUpdated;
